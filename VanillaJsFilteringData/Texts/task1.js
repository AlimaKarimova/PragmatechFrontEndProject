...
// 1. Mətndəki boşluq sayını return edən funksiya yazın             
function bosluqSayi(metn) {
    const bosluq = metn.match(/ /g) //verilen deyeri olan arrayi qaytarir
    // return bosluq.length
    console.log(bosluq.length)  //arayyin uzunlugunu qaytarir
}
bosluqSayi(sampleNews)